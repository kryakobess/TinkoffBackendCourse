...
public interface ScrapperClient {
    ...
    @PostExchange("/links")
    LinkScrapperResponse addNewLink(@RequestHeader("Tg-Chat-Id") long tgChatId,
        @RequestBody AddLinkScrapperRequest link);

    @DeleteExchange("/links")
    LinkScrapperResponse deleteLink(@RequestHeader("Tg-Chat-Id") long tgChatId,
        @RequestBody DeleteLinkScrapperRequest link);
